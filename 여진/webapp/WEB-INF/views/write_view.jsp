	...
	<div class="container" style="width:100%; height:700px">  
		...
		<div class="contents-left">
			<div class="image-editor">
				<!-- <textarea rows="10" cols="20">사진편집툴 자리... ^^</textarea><br/>
				 -->      
				<!-- 파일 업로드 -->
					...
					<div class="modal-body">
						...
						<div>
							mainAddr : <input id="mainAddr" type="text" style="width:50%" >
			          		detail Addr : <input id="detailAddr" type="text" style="width:50%">
			          	</div>
					</div>
					
		          <!-- Modal footer -->
					<div class="modal-footer">
			            <button id="getData" type="button" class="btn btn-success" data-dismiss="modal">확인</button>
			          ...
			          $("#getData").on("click", function(e) {
				          ...
				          document.getElementById("savedAddress").value = mainAddr.concat(" ", detailAddr);
			          });
			          </script>
		        </div>
		      </div>
			...
			<div>
				입력된 위치 정보 : <br/><input type="text" id="savedAddress" style="width:90%">
			</div>
		  </div>
<!-- 		중간 구분선
 -->		
		...
		<!-- 오른쪽 컨텐츠 -->
		<div class="container-right" style="width:45%; height:600px; float:right">
	        <div class="row">
	            <div class="col-sm-9">
	              <div class="input-group mb-3">
	                <div class="input-group-prepend" style="width:100%">
	                  <span class="input-group-text" >제목 : </span>
	                  <input type="text" class="form-control" style="width:80%" placeholder="제목 입력" id="usr" name="username">
	                </div>
	              </div>
