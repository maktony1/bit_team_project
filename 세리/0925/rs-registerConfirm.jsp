...
<script>
   ...
   function check_all() {
        for(i=0; i < my_form.chk.length; i++) {
            my_form.chk[i].checked = true;
        }
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="join-form" >
                        <h2>약관동의</h2>
                        <form action="" id="joinForm" name="my_form">
                            <ul class="join_box">
                                <li class="checkBox check01">
                                    <ul class="clearfix">
                                        ...
                                        <li class="checkAllBtn">
                                            <input type="checkbox" id="chk" class="chkAll" onclick="check_all();" value="all선택">
                                        </li>
                                    </ul>
                                </li>
                                <li class="checkBox check02">
                                    ...
                                    <textarea disabled id="readonly">제 1 조 (목적)
 ...
 ⑤"게시물"이라 함은 "회원"이 "서비스"를 이용함에 있어 "서비스상"에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다. 
                                ...
                                <li class="checkBox check03">
                                    ...
                                    <textarea disabled id="readonly">정보통신망법 규정에 따라 RestfuLL에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 RestfuLL 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, RestfuLL는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
                                ...
                                <li class="checkBox check03">
                                    ...
                                    <textarea disabled id="readonly">위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 RestfuLL 위치기반 서비스를 이용할 수 있습니다.
...
3. 이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도 등을 차단합니다.
                            ...
                            <ul class="footBtwrap clearfix">
                                <li><button type="button" class="fpmgBt2" data-toggle="modal" data-target="#exampleModal">확인</button></li>
                            </ul>
                        </form>
